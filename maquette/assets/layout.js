...
( function () {
	...
	var nav = [
		...
		[ 'cioff', 'le-cioff.html', 'Le CIOFF' ],
		[ 'jeunes', '#', 'CIOFF Jeunes' ],
		[ 'annuaire', 'annuaire.html', 'Annuaire' ],
		[ 'agenda', '#', 'Agenda' ],
		[ 'engager', 'le-cioff.html#engager', "S'engager" ],
		[ 'outils', '#', 'Boîte à outils' ],
		[ 'mon-espace', 'mon-espace.html', 'Intranet' ],
		[ 'contact', '#', 'Contact' ],
	];

	var reseaux = '<ul class="cioff-reseaux"><li><a class="cioff-reseaux__facebook" href="#" aria-label="Facebook">f</a></li><li><a class="cioff-reseaux__instagram" href="#" aria-label="Instagram">◎</a></li><li><a class="cioff-reseaux__youtube" href="#" aria-label="YouTube">▶</a></li></ul>';
	var bandeau = '<div class="maquette-bandeau">Maquette de présentation – adhérents et textes repris de cioff-france.org ; événements, photos et comptes <strong>fictifs</strong>. ' +
